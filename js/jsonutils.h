...
void json_free_object(json_object *, int);
json_array *json_new_array(void);
void json_free_member(json_object_member *, int);
void json_object_append_object(json_object *, char *, json_object *);
void json_object_append_array(json_object *, char *, json_array *);
void json_object_append_integer(json_object *, char *, int);
void json_object_append_real(json_object *, char *, double);
void json_object_append_time(json_object *, char *, unsigned long);
void json_object_append_time_t(json_object *, char *, time_t);
void json_set_time_t(json_object_member *, time_t);
void json_object_append_string(json_object *, char *,
		const json_escape *, char *, ...);
void json_object_append_boolean(json_object *, char *, int);
void json_array_append_object(json_array *, json_object *);
void json_array_append_array(json_array *, json_array *);
void json_array_append_integer(json_array *, int);
void json_array_append_real(json_array *, double);
void json_array_append_time(json_array *, unsigned long);
void json_array_append_time_t(json_array *, time_t);
void json_array_append_string(json_array *, const json_escape *,
		char *, ...);
void json_array_append_boolean(json_array *, int);
void json_object_append_duration(json_object *, char *, unsigned long);
void json_array_append_duration(json_object *, unsigned long);
json_object_member *json_get_object_member(json_object *, char *);
json_object_member *json_get_array_member(json_object *, char *);
void json_object_print(char *buffer, json_object *, int, int, char *, unsigned);
void json_array_print(json_array *, int, int, char *, unsigned);
void json_member_print(json_object_member *, int, int, char *, unsigned);

// json_object *json_result(time_t, char *, char *, int, time_t, authdata *,
// 		int, char *, ...);
json_object *json_help(option_help *);
int passes_start_and_count_limits(int, int, int, int);
void indentf(int, int, char *, ...);
void json_string(int, int, char *, char *);
void json_boolean(int, int, char *, int);
void json_int(int, int, char *, int);
void json_unsigned(int, int, char *, unsigned long long);
void json_float(int, int, char *, double);
void json_time(int, int, char *, unsigned long);
void json_time_t(int, int, char *, time_t, char *);
void json_duration(int, int, char *, unsigned long, int);

void json_enumeration(json_object *, unsigned, char *, int, 
		const string_value_mapping *);
void json_bitmask(json_object *, unsigned, char *, int, 
		const string_value_mapping *);

// int parse_bitmask_cgivar(char *, char *, int, json_object *, time_t,
// 		authdata *, char *, char *, const string_value_mapping *, unsigned *);
// int parse_enumeration_cgivar(char *, char *, int, json_object *,
// 		time_t, authdata *, char *, char *, const string_value_mapping *,
// 		int *);
// int parse_string_cgivar(char *, char *, int, json_object *, time_t,
// 		authdata *, char *, char *, char **);
// int parse_time_cgivar(char *, char *, int, json_object *, time_t,
// 		authdata *, char *, char *, time_t *);
// int parse_boolean_cgivar(char *, char *, int, json_object *, time_t,
// 		authdata *, char *, char *, int *);
// int parse_int_cgivar(char *, char *, int, json_object *, time_t,
// 		authdata *, char *, char *, int *);

int get_query_status(const int[][2], int);
char *svm_get_string_from_value(int, const string_value_mapping *);
char *svm_get_description_from_value(int, const string_value_mapping *);

time_t compile_time(const char *, const char *);
char *json_escape_string(const char *, const json_escape *);
#endif
